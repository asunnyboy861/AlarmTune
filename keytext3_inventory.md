...
| AlarmKit System-Level Alarm (iOS 26+) | AlarmKitAdapter.swift (DISABLED - needs further testing) | DISABLED | n/a | Not mentioned in keytext (disabled due to alarm not ringing regression) |
